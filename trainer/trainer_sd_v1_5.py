...
class Trainer:
    def __init__(self, diff_model, configs):
        ...
        if configs.train_phase == "vae":
            ...
            # Load tokenizer
            self.tokenizer = diff_model.tokeinzer
            
            # Load scheduler
            self.noise_scheduler = diff_model.noise_scheduler
            ...
            (self.vae,
             ...
             self.train_loader, 
             self.eval_loader) = self.accelerator.prepare(
                vae, unet, text_encoder, vlm, r_projector, optimizer, lr_scheduler, train_loader, eval_loader
            )
